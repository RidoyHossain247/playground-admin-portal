            ...
            <DialogContent>
               ...
               <Box>
                  <Typography
                     ...
                     <span style={{ fontWeight: 'normal', color: '#c1c7c2' }}>Date&Time</span> {dateTime(orderData?.order?.createdAt)}
                  </Typography>
               </Box>
               <Box>
                        ...
                        <TableBody>
                           {pdtData && pdtData?.length !== 0 && pdtData?.map((item, i) => (
                              ...
                              <StyledTableRow key={item._id}>
                                 ...
                                 <StyledTableCell sx={{ p: 1 }} component="th" scope="row">{shortText(item?.product?.description, 30)}</StyledTableCell>
                                 ...
                                 <StyledTableCell sx={{ p: 1 }} component="th" scope="row">
                                    ...
                                    <Typography sx={{ display: "block" }}> ৳ {item?.product?.price}</Typography>
                                 </StyledTableCell>
