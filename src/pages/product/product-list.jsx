...
const ColorList = () => {
    ...
    const subcategory = useData("/subcategories")
    const colors = useData("/colors")
    const Sizes = useData("/sizes")

    const scatData = subcategory.data
